...
public class All_Sortings {
    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            switch (select) {
                case 1:
                    All_Sortings.B_Sort(a, 0, n - 1);
                    All_Sortings.printlist(a);
                    break;
                case 2:
                    All_Sortings.selection_Sort(a, 0, a.length - 1);
                    All_Sortings.printlist(a);
                    break;
                case 3:
                    All_Sortings.mergeSort(a, 0, a.length - 1);
                    All_Sortings.printlist(a);
                    break;
                case 4:
                    All_Sortings.quick(a, 0, a.length - 1);
                    All_Sortings.printlist(a);
                    break;
                case 5:
                    All_Sortings.Insertion(a, 0, a.length - 1);
                    All_Sortings.printlist(a);
                    break;
                case 0:
                    flag = false;
